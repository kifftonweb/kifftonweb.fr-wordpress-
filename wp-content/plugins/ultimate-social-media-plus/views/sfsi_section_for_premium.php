        ...
        <div class="sfsi-footer-pointing-to-premium-plugin" style="width: 75%;">
            <div class="sfsi-footer-pointing-content clearfix">
                <div class="sfsi-footer-left-section">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p class="so-much-more">...and <a target="_blank" href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=new_bottom_banner_to_checkout&utm_medium=banner">so much more</a></p>
                        </div>
                    </div>
                </div>
                <div class="sfsi-footer-right-section">
                    ...
                    <a target="_blank" href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=new_bottom_banner_to_checkout&utm_medium=banner" class="sfsi-checkout-premium-plugin-button">Check out the Premium Plugin >></a>
                </div>
            </div>
        </div>
