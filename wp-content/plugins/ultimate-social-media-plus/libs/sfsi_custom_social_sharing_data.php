    ...
    <div class="sfsi-post-meta-wrapper">
        <div class="social_data_container_first">
            ...
            <div class="sfsi_custom_social_data_container">
                ...
                <div class="imgTopTxt"><?php _e('<strong>Picture </strong>(for social media sharing)', SFSI_PLUS_DOMAIN); ?>
                </div>
            ...
            <div class="sfsi_custom_social_titlePlusDescription">
                ...
                <div class="sfsi_titlePlusDescription">
                    ...
                    <div class="sfsi_custom_social_data_title">
                        ...
                        <div class="imgTopTxt">
                            <?php _e('<strong>Title </strong>(leave blank to use the post title)', SFSI_PLUS_DOMAIN); ?></div>

                        <div class="social_title"><textarea readonly name="social_fbGLTw_title_textarea" class="sfsi_textarea" maxlength="95"></textarea>
                        </div>
                        ...
                        <div class="remaining_char_box" class="sfsi-remaining_char_title">
                            <?php _e('<span id="sfsi_title_remaining_char">95</span> Characters Remaining', SFSI_PLUS_DOMAIN); ?>
                        </div>
                    ...
                    <div class="sfsi_custom_social_data_description">
                        ...
                        <div class="imgTopTxt">
                            <?php _e('<strong>Description </strong>(leave blank to use the post exerpt)', SFSI_PLUS_DOMAIN); ?>
                        </div>
                        ...
                        <div class="remaining_char_box">
                            <?php _e('<span id="sfsi_desc_remaining_char">297</span> Characters Remaining', SFSI_PLUS_DOMAIN); ?>
                        </div>
        ...
        <div class="social_data_container_second">
            ...
            <div class="sfsi_custom_social_data_container">
                ...
                <div class="imgTopTxt"><?php _e('<strong>Pinterest image </strong>', SFSI_PLUS_DOMAIN); ?></div>
                ...
                <div class="imgUploadBtn"><input readonly disable type="button" disable class="button sfsi-post-meta-btn" value="<?php _e($uploadBtnTitle, SFSI_PLUS_DOMAIN); ?>" /></div>
            </div>
            ...
            <div class="sfsi_custom_social_titlePlusDescription">
                ...
                <div class="sfsi_titlePlusDescription">
                    ...
                    <div class="sfsi_custom_social_data_title">
                        <div class="imgTopTxt">
                            <?php _e('<strong>Pinterest description </strong>(leave blank to use the post title)', SFSI_PLUS_DOMAIN); ?>
                        </div>

                        <div class="social_title"><textarea readonly name="social_pinterest_description_textarea" class="sfsi_textarea"></textarea></div>
                    ...
                    <div class="sfsi_custom_social_data_description">
                        ...
                        <div class="imgTopTxt"><?php _e('<strong>Tweet </strong>', SFSI_PLUS_DOMAIN); ?></div>

                        <div class="social_description_container"><textarea name="social_twitter_description_textarea" readonly class="sfsi_textarea" maxlength="106"></textarea>
                        </div>
                        ...
                        <div class="remaining_char_box" id="remaining_twiter_char_description">
                            <?php _e('<span id="sfsi_twitter_desc_remaining_char">106</span> Characters Remaining', SFSI_PLUS_DOMAIN); ?>
                        </div>
        ...
        <div style='display:none; background: rgb(221, 221, 221);' class="sfsi-post-tooltip">
            ...
            <a target="_blank" href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_post_or_page&utm_campaign=usm_sharing_texts_and_images_section&utm_medium=banner" class="font-italic text-success" style="color: #28a745!important;font-family: helvetica-light;font-size: 17px;">click to learn more</a>
        </div>
    </div>
<?php }
...
function sfsi_plus_icons_add_meta_boxes()
{
    ...
    if ($hideSectionVal == 'no') {
        if (isset($screen->post_type) && ('page' == $screen->post_type || 'post' == $screen->post_type)) {
            add_meta_box('sfsi-plus-social-media', 'Ultimate Social Media – Define which pictures & texts will get shared', 'sfsi_plus_social_media_metabox', $screen->post_type, 'normal', 'low');
        }
    }
}
